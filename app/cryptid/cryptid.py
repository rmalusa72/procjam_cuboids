from app.cryptid.assets import all
...
class Cryptid: 
    ...
    def __init__(color, bodyparts, coords):
        self.color = color
...
class Torso: 
    ...
    def __init__(variant = DEFAULT_TORSO, port1 = None, port2 = None, port3 = None, port4 = None, port5 = None, port6 = None): 
